...
function (_Component) {
  ...
  Chat__createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      this.pusher = new external__pusher_js__default.a("93efde97c98585993b41", {
        cluster: "eu",
        encrypted: true
      });
    ...
    value: function render() {
      ...
      return this.props.activeUser && external__react__default.a.createElement(external__react_["Fragment"], null, external__react__default.a.createElement("div", {
        ...
        }, String.fromCodePoint.apply(String, mood)), external__react__default.a.createElement("span", null, chat.user || 'Anonymous')), external__react__default.a.createElement(ChatMessage_ChatMessage, {
...
function (_Component) {
  ...
  function Index() {
    ...
    return pages__possibleConstructorReturn(_this, (_temp = _this = pages__possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), Object.defineProperty(pages__assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  pages__createClass(Index, [{
    ...
    value: function render() {
      ...
      }, user && external__react__default.a.createElement(Chat_Chat, {
        activeUser: user
      })))));
    }
  }]);
